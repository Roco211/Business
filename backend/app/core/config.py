...
class Settings:
    ...
    llm_provider_api_url: str | None = os.getenv("LLM_PROVIDER_API_URL")
    llm_provider_api_key: str | None = os.getenv("LLM_PROVIDER_API_KEY")
    llm_provider_model: str | None = os.getenv("LLM_PROVIDER_MODEL")
    llm_timeout_seconds: float = float(os.getenv("LLM_TIMEOUT_SECONDS", "30"))
    llm_max_tokens: int = int(os.getenv("LLM_MAX_TOKENS", "500"))
    llm_temperature: float = float(os.getenv("LLM_TEMPERATURE", "0.7"))
    llm_allow_mock_fallback: bool = os.getenv("LLM_ALLOW_MOCK_FALLBACK", "1") not in ("0", "false", "False")
