...
import type { ApiEnvelope, AuthState, Confirmation, Customer, CustomerRepurchaseAnalysis, DailyAdvisorReport, DailyReportHistory, ExecutionRecapList, FinanceSummary, FinanceTransaction, InventoryItem, LedgerEvent, Overview, PurchaseOrder, SalesOrder, Shop, StockItem, Supplier, Tenant } from './types'
...
export const api = {
  ...
  getExecutionRecaps: (auth: AuthState, limit = 50) => request<ExecutionRecapList>(`/api/v2/pc-dashboard/execution-recaps?limit=${limit}`, {}, auth),
